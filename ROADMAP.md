...
**제보 목록**:
- [ ] 전체 제보 조회 (필터: 상태, 유형, 날짜, 지역)
- [ ] 제보 상세 보기
- [ ] 지도에서 제보 위치 확인
- [ ] 이미지 확대 보기

**제보 처리**:
- [ ] 상태 변경 (접수 → 검토중 → 반영완료/반려)
- [ ] 검토 메모 작성
- [ ] 우수 제보 선정 (추가 포인트 지급)
- [ ] 반려 시 사유 입력 및 알림
...
2. **관리자 페이지 기본** - 제보 목록/상태 변경
3. **서버 검증 추가** - Firebase Functions로 기본 검증
